/*
object Versions {
    const val KOTLIN_VERSION = "1.8.20" //O
    const val KOTLINX_COROUTINES = "1.3.9" //o
    const val BUILD_GRADLE = "4.2.1"
    const val COMPILE_SDK_VERSION = 33 //0
    const val BUILD_TOOLS_VERSION = "30.0.3"
    const val MIN_SDK_VERSION = 26 //o
    const val TARGET_SDK_VERSION = 33  //o

    const val CORE_KTX = "1.8.0" //o
    ...
    const val HILT = "2.38.1" //o
    const val MATERIAL = "1.3.0"

    const val RETROFIT = "2.9.0" //o
    const val OKHTTP = "4.3.1"

    const val JUNIT = "4.13.2" //o
    const val ANDROID_JUNIT = "1.1.5" //o
    const val ESPRESSO_CORE = "3.5.1" //o
}
